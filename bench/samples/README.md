...
measurement design describes. Promotion refuses an arm collected under
`--rules user`, records a license check for samples that reproduce source
text, and scans for operator configuration content. A promoted study is
