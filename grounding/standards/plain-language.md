...
| G-01 | Identify your reader before you write, and learn what they must do. | Audience | audience/do-your-research | unquoted | Audience | unaudited |
| G-02 | Address the reader directly as `you`. | Audience | audience/address-the-user | unquoted | Audience | unaudited |
| G-03 | Separate the guidance for each audience when one document serves several. | Audience | audience/address-separate-audiences-separately | unquoted | Audience | unaudited |
| G-04 | Put the main idea before any exception or condition. | Organization | organize/place-the-main-idea-before-exceptions-and-conditions | unquoted | Organize | unaudited |
| G-05 | Start each section with the point, not with the background. | Organization | organize/make-it-easy-to-follow | unquoted | Organize | unaudited |
| G-06 | Give each paragraph a topic sentence. | Organization | organize/have-a-topic-sentence | unquoted | Organize | unaudited |
| G-07 | Write headings that state the content, and prefer the question the reader asks. | Organization | organize/add-useful-headings, organize/effective-headings | unquoted | Organize | unaudited |
| G-08 | Use a list when the text holds several conditions, steps, or items. | Organization | organize/use-lists | unquoted | Organize | unaudited |
| G-09 | Use transition words to show how one idea follows another. | Organization | organize/use-transition-words | unquoted | Organize | unaudited |
| G-10 | Use the simple word in place of the formal word. | Words | words/use-simple-words-phrases | unquoted | Words | unaudited |
| G-11 | Replace a hidden verb with the verb itself. Write `apply`, not `make an application`. | Words | words/avoid-hidden-verbs | unquoted | Words | unaudited |
| G-12 | Do not use jargon. Define a technical term when the reader needs it. | Words | words/avoid-jargon | unquoted | Words | unaudited |
| G-13 | Do not build long noun strings. Break them apart with prepositions. | Words | words/avoid-noun-strings | unquoted | Words | unaudited |
| G-14 | Use the same term for the same thing every time. | Words | words/use-the-same-terms-consistently | unquoted | Words | unaudited |
| G-15 | Use few abbreviations. An abbreviation that the reader must memorize costs more than it saves. | Words | words/minimize-abbreviations | unquoted | Words | unaudited |
| G-16 | Define few terms. A definition that contradicts ordinary usage confuses the reader. | Words | words/minimize-definitions | unquoted | Words | unaudited |
| G-17 | Put each word close to the word that it modifies. | Words | words/place-words-carefully | unquoted | Words | unaudited |
| G-18 | Write short sentences, and put one idea in each sentence. | Concision | concise/write-short-sentences | unquoted | Be concise | unaudited |
| G-19 | Keep the subject, the verb, and the object close together. | Concision | concise/keep-the-subject-verb-and-object-close-together | unquoted | Be concise | unaudited |
| G-20 | Write short paragraphs and short sections. | Concision | concise/write-short-paragraphs, concise/write-short-sections | unquoted | Be concise | unaudited |
| G-21 | State what is true rather than what is not true. | Concision | concise/use-positive-language | unquoted | Be concise | unaudited |
| G-22 | Use the active voice, and name the actor. | Tone | conversational/use-active-voice | unquoted | Be conversational | unaudited |
| G-23 | Use the present tense. | Tone | conversational/use-the-present-tense | unquoted | Be conversational | unaudited |
| G-24 | Use `must` to state a requirement. | Tone | conversational/use-must-to-indicate-requirements | unquoted | Be conversational | unaudited |
| G-25 | Do not use `shall`. It is ambiguous, and courts have read it both ways. | Tone | conversational/shall-and-must | unquoted | Be conversational | unaudited |
| G-26 | Use contractions where they suit the reader and the register. | Tone | conversational/use-contractions | unquoted | Be conversational | unaudited |
| G-27 | Give an example when a rule is hard to picture. | Tone | conversational/use-examples | unquoted | Be conversational | unaudited |
| G-28 | Do not use a slash between two words. Write the relationship out. | Tone | conversational/dont-use-slashes | unquoted | Be conversational | unaudited |
| G-29 | Use a table when the reader must match a condition to a result. | Design | design/use-tables-to-make-complex-material-easier-to-understand | unquoted | Design | unaudited |
| G-30 | Highlight the concepts that carry the decision. | Design | design/highlight-important-concepts | unquoted | Design | unaudited |
| G-31 | Use few cross-references. Each one sends the reader away from the answer. | Design | design/minimize-cross-references | unquoted | Design | unaudited |
| G-32 | Use a visual when it carries the meaning better than a sentence does. | Design | design/consider-using-visuals | unquoted | Design | unaudited |
| G-33 | Write link text that names the destination. | Web | web/write-effective-links | unquoted | Write for the web | unaudited |
| G-34 | Do not publish a long PDF where a web page serves the reader better. | Web | web/avoid-pdf-overload | unquoted | Write for the web | unaudited |
| G-35 | Rewrite print material for the web. Do not paste it. | Web | web/repurpose-print-material | unquoted | Write for the web | unaudited |
| G-36 | Avoid a page of frequently asked questions. Organize the content by topic instead. | Web | web/avoid-faqs | unquoted | Write for the web | unaudited |
| G-37 | Test the document with real readers before you publish it. | Testing | test/usability-testing | unquoted | Test | unaudited |
| G-38 | Ask a reader to restate the content in their own words. | Testing | test/paraphrase-testing | unquoted | Test | unaudited |
