# Grounding: skills/standards/simplified-technical-english/references/rule-navigation.md
...
The steps under `Source-use boundary` are `E` rows. They tell a reader how to
use this map, and they state no rule of the standard.
