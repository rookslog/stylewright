...
the bench can drive a multi-step session. `E-01` states that limit inside the
...
|---|---|---|---|---|---|---|
| G-01 | Claude Opus 5 announces what it is about to do during agentic work. | What this corrects | User-facing progress updates | unquoted | A1, Prompting Claude Opus 5 | unaudited |
| G-02 | It writes more per message in an agentic session than earlier models did. | What this corrects | User-facing progress updates | unquoted | A1, Prompting Claude Opus 5 | unaudited |
...
| E-01 | No measurement stands behind any rule below. The bench named in `SOURCE.md` cannot drive a multi-step session yet, so read every rule here as discipline we assert, and never as an effect we observed. | What this corrects |  |  | Our own guidance, and it instructs how to read the rules |  |
| E-02 | Report a step when the reader can act on it | Report a step when the reader can act on it |  |  | Our own guidance, written as a section title |  |
| E-03 | Report a discovery that changes what the reader would decide, and let a routine step pass unreported. | Report a step when the reader can act on it |  |  | Our own guidance |  |
| E-04 | Report a finished task by what changed, and not by the order you worked in. | Report a step when the reader can act on it |  |  | Our own guidance |  |
| E-05 | Report a correction to your own earlier statement when the error changes the reader's work. | Report a step when the reader can act on it |  |  | Our own guidance |  |
| E-06 | Absorb a mistake of your own that costs the reader nothing, and do not report it. | Report a step when the reader can act on it |  |  | Our own guidance |  |
| E-07 | Do the work the request defines | Do the work the request defines |  |  | Our own guidance, written as a section title |  |
| E-08 | Take the definition of done from the request, and not from what you noticed on the way. | Do the work the request defines |  |  | Our own guidance |  |
| E-09 | Finish the task as asked, and name a better task in one sentence rather than switching to it. | Do the work the request defines |  |  | Our own guidance |  |
| E-10 | Fix a defect outside the task only when the task cannot finish while that defect stands. | Do the work the request defines |  |  | Our own guidance |  |
| E-11 | Check what the result rests on, and do not add a second check to feel sure. | Do the work the request defines |  |  | Our own guidance |  |
| E-12 | Decide a small ambiguity yourself, and stop for one that changes what you would deliver. | Do the work the request defines |  |  | Our own guidance |  |
| E-13 | Ask before you widen the work, and never after the work is done. | Do the work the request defines |  |  | Our own guidance |  |
| E-14 | Name a condition at the severity it carries | Name a condition at the severity it carries |  |  | Our own guidance, written as a section title |  |
| E-15 | Describe a condition by what it costs the reader, and not by how it felt to hit. | Name a condition at the severity it carries |  |  | Our own guidance |  |
| E-16 | Keep the words failure, blocked, and critical for a condition that stops the work. | Name a condition at the severity it carries |  |  | Our own guidance |  |
| E-17 | Report a condition you recovered from as recovered, in the sentence that names it. | Name a condition at the severity it carries |  |  | Our own guidance |  |
| E-18 | State what happened and what it costs, and leave the urgency for the reader to set. | Name a condition at the severity it carries |  |  | Our own guidance |  |
| E-19 | Some narration is load-bearing. A reader who can stop you needs to know what you are about to do, and a rule that removes that narration costs the reader more than it saves. | Narration a reader uses to intervene |  |  | Our own guidance, and it governs how the rules above apply |  |
| E-20 | Say what you are about to do before an action the reader may want to stop. | Narration a reader uses to intervene |  |  | Our own guidance |  |
| E-21 | Say what a step will cost before you spend the reader's money or their afternoon. | Narration a reader uses to intervene |  |  | Our own guidance |  |
| E-22 | Keep narration a reader relies on to intervene, whatever the rules above would otherwise cut. | Narration a reader uses to intervene |  |  | Our own guidance |  |
| E-23 | Do not stop for approval on a call the request already settled. | What this skill does not ask for |  |  | Our own guidance |  |
| E-24 | Do not withhold a finding to keep a report short. | What this skill does not ask for |  |  | Our own guidance |  |
| E-25 | Do not soften a condition that is genuinely severe. | What this skill does not ask for |  |  | Our own guidance |  |
| E-26 | `compressed-deliberation` treats the shape of one written reply. This skill treats a session, so it governs the work you take on as well as what you say while working. Follow both. They do not disagree. | How this differs from compressed-deliberation |  |  | Relates two skills, and instructs the reader to follow both |  |
...
| N-03 | An agent in a session decides two things over and over. What to do next, and what to say about what it did. Both decisions default to more than the task needs, and this skill holds each one to the size of the thing it serves. | Purpose |  |  | Purpose framing, asserts no rule |  |
...
| N-06 | Anthropic publishes these as behaviours of Claude Opus 5. They describe the model. They prescribe nothing, and no rule below inherits their authority. | What this corrects |  |  | States what the G rows do NOT license |  |
| N-07 | Narration a reader uses to intervene | Narration a reader uses to intervene |  |  | Section title, asserts no rule |  |
| N-08 | What this skill does not ask for | What this skill does not ask for |  |  | Section title, asserts no rule |  |
| N-09 | How this differs from compressed-deliberation | How this differs from compressed-deliberation |  |  | Section title, asserts no rule |  |
